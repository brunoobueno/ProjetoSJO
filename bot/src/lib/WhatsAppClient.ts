...
class WhatsAppClient {
    ...
    //função que armazena a quantidade de pessoas na fila
    private messageProcessedCount: number = 0;
    ...
    private enqueueMessage(message: Message) {
        ...
        if (!this.isProcessingQueue && !this.resetTimer) {
    ...
    private async processMessageQueue() {
        ...
        // Incrementa o contador de mensagens processadas
        this.messageProcessedCount++;

        // Verifica se o limite de mensagens processadas por minuto foi alcançado
        if (this.messageProcessedCount > 20) {
            // Pausa o processamento da fila
            this.isProcessingQueue = false;

            // Define um temporizador para reiniciar o contador após 65 segundos
            this.resetTimer = setTimeout(() => {
                this.messageProcessedCount = 0;
                this.processMessageQueue();
            }, 65000); // 65 segundos em milissegundos
        } else {
            ...
            while (this.messageQueue.length > 0) {
                ...
                // Verifica se o temporizador de reinício está definido e o cancela
                if (this.resetTimer) {
    ...
    mensagem: ${clientMessage}`;
        ...
        switch (category) {
            ...
            case 'produto':
                ...
                const productEndpoint = 'https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/produtos';
            ...
            case 'pagamento':
                ...
                let paymentInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/pagamentos');
            ...
            case 'empresa':
                // Seção para lidar com a categoria 'pagamento'
                let empresaInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/empresa');
            ...
            case 'saudacao':
                // Seção para lidar com a categoria 'pagamento'
                let saudacaoInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/saudacao');
            ...
            case 'troca':
                ...
                let exchangeInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/troca');
            ...
            case 'entrega':
                ...
                let deliveryInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/entrega');
            ...
            case 'promocao':
                // Seção para lidar com a categoria 'troca'
                let promocaoInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/promocao');
            ...
            case 'pedido':
                // Seção para lidar com a categoria 'troca'
                let compraInfo = await this.getJsonInfoFromAPI('https://ab6b-2600-1f18-302b-ad00-ac86-c4d4-b916-1f0a.ngrok-free.app/pedido');
